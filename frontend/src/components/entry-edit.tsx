...
import EditEntryJson from './entry-edit-json';
...
class EditEntry extends Component<EditEntryProp, EditEntryState> {
  TornjakApi: TornjakApi;
  SpiffeHelper: SpiffeHelper;
  constructor(props: EditEntryProp) {
    super(props);
  ...
  componentDidUpdate(prevProps: EditEntryProp, prevState: EditEntryState) {
    if (IsManager) {
